...
<html>
 <head>
    	...
    	<link rel="stylesheet" type="text/css" href="admin/assets/bootstrap-4.0.0/dist/css/bootstrap.css">
    ...
    <body id="page" style="overflow: hidden;">
        ...
        <div class="container">
            ...
            <div class="sty text-center" style="min-height: 100vh;">
		  	<form class="p-5 rounded shadow" action="validate.php" method="post" style="width: 30rem">
